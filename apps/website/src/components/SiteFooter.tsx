  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <div className="footer-links"><strong>VITAMATE</strong><Link href="/nosotros">Nosotros</Link><Link href="/soporte">Soporte</Link><Link href="/privacidad">Privacidad</Link><Link href="/terminos">Términos</Link><a href="mailto:contacto@vitamate.mx">Contacto</a></div>
