...
const Hoy = ({ snapshot, isPremium, onRequestPremium }: { snapshot: VitamateSnapshot; isPremium: boolean; onRequestPremium(): void }) => {
  ...
  return <IonPage className="app-page"><IonContent fullscreen>
    <main className="page-shell dashboard-shell">
      ...
      <section className="quick-section"><h2>Acciones rápidas</h2><div className="quick-grid"><Quick href="/nutricion" icon={restaurantOutline} label="Registrar alimento" /><Quick href="/recordatorios" icon={alarmOutline} label="Recordatorios y agua" />{isPremium && <><Quick href="/entrenar" icon={barbellOutline} label="Iniciar entrenamiento" /><Quick href="/coach" icon={chatbubbleEllipsesOutline} label="Hablar con VITACOACH" accent /></>}</div></section>
