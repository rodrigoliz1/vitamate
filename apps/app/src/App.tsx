      ...
      <IonReactRouter>
        <IonTabs>
          <IonRouterOutlet>
            ...
            <Route exact path="/cuenta" render={() => <Cuenta snapshot={snapshot} cloudEmail={actions.cloud.email} entitlement={actions.billing.entitlement} voiceBalance={actions.billing.voiceBalance} voiceOffers={actions.billing.voiceOffers} billingBusy={actions.billing.busy} billingMessage={actions.billing.message} onPurchaseVoice={actions.billing.purchaseVoice} onOpenSubscription={requirePremium} onSignOut={actions.signOutCloud} onDeleteAccount={actions.deleteAccount} />} />
